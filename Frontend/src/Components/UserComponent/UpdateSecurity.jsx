...
const SecurityTable = () => {
  ...
  useEffect(() => {
    const fetchSecurityList = async () => {
      try {
        const response = await axios.get("http://parkvilla.ap-south-1.elasticbeanstalk.com/api/UserDetails");
  ...
  const handleDelete = async (securityId) => {
    try {
      await axios.delete(`http://parkvilla.ap-south-1.elasticbeanstalk.com/api/UserDetails/${securityId}`);
  ...
  const handleSave = async () => {
    ...
    try {
      await axios.put(`http://parkvilla.ap-south-1.elasticbeanstalk.com/api/UserDetails/${editedSecurity.userId}`, editedSecurity);
      setSecurityList(
