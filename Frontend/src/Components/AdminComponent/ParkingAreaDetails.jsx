...
//     try {
//       await Axios.delete(`http://parkvilla.ap-south-1.elasticbeanstalk.com/api/ParkingAreas/${id}`, {
...
//     }
//     if (!editedArea?.totalSlots.trim() || isNaN(editedArea.totalSlots)) {
//       newErrors.totalSlots = "Total Slots must be a valid number.";
//     }
//     if (!editedArea?.rate.trim() || isNaN(editedArea.rate)) {
...
//     try {
//       await Axios.put(
//         `http://parkvilla.ap-south-1.elasticbeanstalk.com/api/ParkingAreas/${editedArea.areaId}`,
//         editedArea,
//         { headers: headers }
//       );
//       setParkingArea(
