...
const ParkingZoneDetails = () => {
  ...
  const handleDelete = async (id) => {
    try {
      await Axios.delete(`http://parkvilla.ap-south-1.elasticbeanstalk.com/api/ParkingZones/${id}`, {
        headers: {
    ...
    const getZone = async () => {
      try {
        const response = await Axios.get(
          "http://parkvilla.ap-south-1.elasticbeanstalk.com/api/ParkingZones",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleSave = async () => {
    ...
    try {
      await Axios.put(
        `http://parkvilla.ap-south-1.elasticbeanstalk.com/api/ParkingZones/${editedZone.zoneId}`,
        editedZone,
        { headers: headers }
      );
      setZones(
